...
fun Activity.requestPermissionX(permissions: List<String>) = PermissionX.request(this, permissions)

fun Activity.requestPermissionX(permission: String) = PermissionX.request(this, permission)

fun Fragment.requestPermissionX(permissions: List<String>) = PermissionX.request(this, permissions)
